...
const cards = [
    {
        ...
        description: 'Aceito exclusivamente em estabelecimentos como supermercados, açougues, padarias e muito mais.',
        link: '#',
        tag:'Saldo pat',
        icon: ShoppingCart,
        coverUrl: market
        ...
        <section className="w-full py-20 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <h4 className="font-title text-5xl font-bold max-w-2xl text-center">
                        Tenha mais <span className="bg-clip-text text-transparent bg-gradient-to-r from-pink-400 to-pink-500">
                            poder de escolha
                        </span> para aproveitar seus benefícios
                    </h4>
                    <p className="leading-relaxed mt-6 text-center max-w-2xl">
                        Pague suas despesas a trabalho no mesmo cartão. Gerencie os gastos e faça a prestação de contas direto no aplicativo. Simples e fácil.
                    </p>
                </div>

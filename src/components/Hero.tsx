            ...
            <div className="w-full max-w-7xl mx-auto flex justify-between items-center mt-8">
                <div className="max-w-[650px]">
                    ...
                    <h1 className="font-title font-bold text-zinc-800 text-7xl tracking-tight">
                        Liberdade é ter tudo em um <span className="bg-clip-text text-transparent bg-gradient-to-r from-pink-400 to-pink-500">Flash</span>
                    </h1>
                    <p className="text-zinc-600 text-lg mt-6 leading-relaxed">
                        Centralize sua gestão de benefícios, despesas corporativas e muito mais em um só lugar. Ofereça para seus colaboradores um único cartão 
                ...
                <Image quality={100} src={hero} width={429} height={582} alt="" className="max-w-lg w-full" />
            </div>
        </section>
    )
}